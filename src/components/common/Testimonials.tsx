              ...
              {[...Array(5)].map((_, i) => (
                ...
                >
                  ...
                  <path
                    ...
                    fill="rgba(174, 156, 150, 0.1)"
                  />
                  
                  {/* Filled star with gradient and glow */}
                  <g clipPath={`url(#star-fill-${i})`}>
                    <rect
                      x="0"
                      y="0"
                      width={i + 1 <= averageRating ? "20" : 
                            i < averageRating ? `${(averageRating - Math.floor(averageRating)) * 20}` : "0"}
                      height="20"
