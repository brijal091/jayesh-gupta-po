          ...
          <div className="p-6 bg-gradient-to-t from-primary-50 to-transparent">
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                {/* Skills */}
                <div className="mb-4">
                  <h4 className="text-primary-100 font-semibold mb-2">Skills Covered:</h4>
              ...
              <div>
                <div className="space-y-4">
                  <div className="p-4 bg-primary-100/10 rounded-xl border border-primary-100/20">
                    <h4 className="text-primary-100 font-semibold mb-1">Credential ID</h4>
                    <p className="text-white font-mono text-sm">{selectedCertificate.credentialId}</p>
                  </div>
                  
                  <div className="p-4 bg-primary-100/10 rounded-xl border border-primary-100/20">
                    <h4 className="text-primary-100 font-semibold mb-1">Valid Until</h4>
                    <p className="text-white">{selectedCertificate.validUntil}</p>
                  </div>
                  
                  <div className="p-4 bg-primary-100/10 rounded-xl border border-primary-100/20">
                    <h4 className="text-primary-100 font-semibold mb-1">Type</h4>
  ...
  return (
    <div className="rounded-2xl p-6">
      ...
      <p className="text-primary-100 mb-8 opacity-80">
        Industry-recognized certifications validating my expertise across various technologies
      </p>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        <div className="p-4 bg-primary-50/30 rounded-xl border border-primary-100/20 text-center">
          <div className="text-xl font-bold text-primary-100 mb-1">{CERTIFICATES.length}</div>
      ...
      {filteredCertificates.length === 0 && (
        <div className="text-center py-16">
          ...
          <p className="text-primary-100">Try selecting a different category</p>
        </div>
      )}
